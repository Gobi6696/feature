  ...
  Widget build(BuildContext context) {
    ...
    if (allDams.length < 2) {
      return Scaffold(
        ...
        appBar: AppBar(title: Text(Localization.translate('compare_title', lang)), backgroundColor: Colors.white),
        body: Center(
          child: Text(Localization.translate('need_two_dams', lang), style: const TextStyle(color: Colors.black87)),
        ),
      );
    }
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(Localization.translate('reservoir_a', lang), style: const TextStyle(color: Colors.grey, fontSize: 9, fontWeight: FontWeight.bold)),
                    ...
                    child: DropdownButton<String>(
                      ...
                      items: allDams.map((dam) {
                        return DropdownMenuItem<String>(
                          value: dam.id,
                          child: Text(Localization.translateDamName(dam.id, dam.name, lang), overflow: TextOverflow.ellipsis),
                        );
                      }).toList(),
                    ),
                  ),
          ...
          Container(
            ...
            child: const Text("VS", style: TextStyle(color: Color(0xFF00E5FF), fontSize: 10, fontWeight: FontWeight.bold)),
          ),
          const SizedBox(width: 16),
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(Localization.translate('reservoir_b', lang), style: const TextStyle(color: Colors.grey, fontSize: 9, fontWeight: FontWeight.bold)),
                const SizedBox(height: 4),
                Container(
                  padding: const EdgeInsets.symmetric(horizontal: 8),
                  decoration: BoxDecoration(
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(flex: 3, child: Text(Localization.translate('metric', lang), style: const TextStyle(color: Colors.grey, fontSize: 10, fontWeight: FontWeight.bold))),
                Expanded(flex: 4, child: Text(Localization.translateDamName(damA.id, damA.name, lang), style: const TextStyle(color: Color(0xFF0288D1), fontSize: 10, fontWeight: FontWeight.bold, overflow: TextOverflow.ellipsis))),
                Expanded(flex: 4, child: Text(Localization.translateDamName(damB.id, damB.name, lang), style: const TextStyle(color: Color(0xFF00E676), fontSize: 10, fontWeight: FontWeight.bold, overflow: TextOverflow.ellipsis))),
              ],
            ),
          ),
          const Divider(color: Color(0xFF334155), height: 1),

          _buildCompareRow(Localization.translate('district_loc', lang), Localization.translateDistrict(damA.district, lang), Localization.translateDistrict(damB.district, lang)),
          _buildCompareRow(Localization.translate('river_basin', lang), Localization.translateRiver(damA.river, lang), Localization.translateRiver(damB.river, lang)),
            ...
            children: [
              ...
              Expanded(
                ...
                child: Text(
                  valTextA,
                  style: TextStyle(
                    color: isAHigher ? const Color(0xFF00E5FF) : Colors.white,
                    fontSize: 11,
              ...
              Expanded(
                ...
                child: Text(
                  valTextB,
                  style: TextStyle(
                    color: isBHigher ? const Color(0xFF00E5FF) : Colors.white,
                    fontSize: 11,
              ...
              Expanded(
                ...
                child: Align(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: alertColorA.withOpacity(0.1),
                      borderRadius: BorderRadius.circular(6),
                      border: Border.all(color: alertColorA.withOpacity(0.4)),
                    ),
                    child: Text(
                      Localization.translate(damA.alertLevel.toLowerCase(), lang),
                      style: TextStyle(color: alertColorA, fontSize: 10, fontWeight: FontWeight.bold),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
                  ),
              ...
              Expanded(
                ...
                child: Align(
                  ...
                  child: Container(
                    padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                    decoration: BoxDecoration(
                      color: alertColorB.withOpacity(0.1),
                      borderRadius: BorderRadius.circular(6),
                      border: Border.all(color: alertColorB.withOpacity(0.4)),
                    ),
                    child: Text(
                      Localization.translate(damB.alertLevel.toLowerCase(), lang),
                      style: TextStyle(color: alertColorB, fontSize: 10, fontWeight: FontWeight.bold),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
                  ),
